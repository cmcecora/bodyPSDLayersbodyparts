...
export const BODY_SYSTEMS: BodySystemDefinition[] = [
  {
    ...
    organIds: ["heart"],
    detailBodyPartIds: ["bp_blood", "bp_blood_vessels"],
  },
  {
    id: "digestive",
    title: "Digestive",
    ...
    detailBodyPartIds: ["bp_colon", "bp_rectum", "bp_anus"],
  },
  {
    id: "endocrine",
    title: "Endocrine",
